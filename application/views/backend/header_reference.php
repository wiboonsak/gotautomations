...
<?php 
if($currentID){
 $imgreference = $this->Product_model->loadreferenceImg($currentID); 
 foreach ($imgreference->result() AS $imgreference3){}
}
 ?>
<html>
    <head>
        ...
        <meta property="fb:app_id"        content="355179808591281"/>
         <meta property="og:url"           content="<?php echo base_url('Reference/Reference_detail/').$currentID?>"/>
         <meta property="og:type"          content="website"/>
        <meta property="og:title"         content="<?php echo $reference_title?>"/>
        <meta property="og:description"   content="<?php echo strip_tags($reference_detail)?>"/>
                ...
                <div class="container-fluid">
                    ...
                    <div class="logo">
                        ...
                        <a href="<?php echo base_url('control')?>" class="logo">
                            ...
                            <img src="<?php echo base_url('HTML_2/images/logo-dark.png')?>" alt="" height="40" class="logo-large">
                        </a>
                        ...
                        <ul class="navigation-menu">
                            ...
                            <li class="has-submenu">
                                ...
                                <ul class="submenu">
                                    ...
                                    <li><a href="<?php echo base_url('Control2/service_detail_add')?>">Add Service Detail</a></li>
                                    <li><a href="<?php echo base_url('Control2/service_detail_list')?>">List All Service Detail</a></li>
